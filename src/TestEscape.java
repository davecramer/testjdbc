...
public class TestEscape {
    ...
    public static void main(String[] args) throws Exception{
        try (Connection c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/test", "test", "test")) {
            try (
                ...
                testEscapeFunc(insert, read, TestEscape::pgEscape);
                testEscapeFunc(insert, read, TestEscape::pgEscapeDollar);
            }
        }
    }
}
